							...
							<div id="tab1" class="tab_content">
								...
								<div class="show_add" style="display: none">
									...
									<form id="create_user_form" action="#">
										...
										<div id="selected_user" style="display: none;"></div>
											<div id="create_user_div">
												<a class="uibutton" id="create_user">Tạo mới</a>
											</div>
											<div id="update_user_div" style="display: none;">
												<a class="uibutton" id="update_user">Cập nhật</a>
											</div>
										</div>
									</form>
									<script type="text/javascript" src="../styles/ziceadmin/js/sontq/user.js">
									</script>

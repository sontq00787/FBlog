...
<head>
    ...
    <!-- Link css-->
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/css/zice.style.css"/>
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/css/icon.css"/>
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/css/ui-custom.css"/>
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/css/timepicker.css"  />
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/colorpicker/css/colorpicker.css"  />
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/elfinder/css/elfinder.css" />
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/datatables/dataTables.css"  />
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/validationEngine/validationEngine.jquery.css" />
     
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/jscrollpane/jscrollpane.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/fancybox/jquery.fancybox.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/tipsy/tipsy.css" media="all" />
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/editor/jquery.cleditor.css"  />
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/chosen/chosen.css" />
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/confirm/jquery.confirm.css" />
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/sourcerer/sourcerer.css"/>
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/fullcalendar/fullcalendar.css"/>
    <link rel="stylesheet" type="text/css" href="styles/ziceadmin/components/Jcrop/jquery.Jcrop.css"  />
    ...
    <script type="text/javascript" src="styles/ziceadmin/components/ui/jquery.autotab.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/ui/timepicker.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/colorpicker/js/colorpicker.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/checkboxes/iphone.check.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/elfinder/js/elfinder.full.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/datatables/dataTables.min.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/datatables/ColVis.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/scrolltop/scrolltopcontrol.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/fancybox/jquery.fancybox.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/jscrollpane/mousewheel.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/jscrollpane/mwheelIntent.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/jscrollpane/jscrollpane.min.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/spinner/ui.spinner.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/tipsy/jquery.tipsy.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/editor/jquery.cleditor.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/chosen/chosen.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/confirm/jquery.confirm.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/validationEngine/jquery.validationEngine.js" ></script>
    <script type="text/javascript" src="styles/ziceadmin/components/validationEngine/jquery.validationEngine-en.js" ></script>
    <script type="text/javascript" src="styles/ziceadmin/components/vticker/jquery.vticker-min.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/sourcerer/sourcerer.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/fullcalendar/fullcalendar.js"></script>
    <script type="text/javascript" src="styles/ziceadmin/components/flot/flot.js"></script>
...
<body class="dashborad">
    ...
    <div id="header" >
        <div id="account_info"> 
			...
			<div class="setting" title="Profile Setting"><b>Welcome,</b> <b class="red">John Doe</b><img src="styles/ziceadmin/images/gear.png" class="gear"  alt="Profile Setting" ></div>
			<div class="logout" title="Disconnect"><b >Logout</b> <img src="styles/ziceadmin/images/connect.png" name="connect" class="disconnect" alt="disconnect" ></div> 
        </div>
    </div> <!--//  header -->
